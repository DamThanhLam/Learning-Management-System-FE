...
export default function TeacherCard({ name, expertise, rating, students, urlAva }: TeacherCardProps) {
  return (
    <div className="bg-white border rounded-lg p-4 text-center shadow-md">
      ...
      <p className="text-yellow-500">{"⭐".repeat(Math.round(rating))} {rating}</p>
